...
<header>
    ...
    <div class="heroe">
        ...
        <h4>Added with Google Bucket Edition</h2>
...
<section>
    ...
    <h1>About this bucket</h1>

    <p>Additional bucket from google cloud storage.</p>
...
$bucketName = 'irm-learn-bucket' . rand();

# Creates the new bucket
$bucket = create_bucket_class_location($bucketName);

echo 'Bucket ' . $bucket . ' created.';

# function for bucket maker
